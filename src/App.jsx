...
export default function App() {
  ...
  return (
    <>
      <div className="logo">
        <img src="src\assets\oasislogoNew.png" alt="osaislogo" className='oasislogo' />
      </div>
